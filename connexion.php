...
if(isset($_SESSION['id_cli']))  { 
			 ...
			 header('Location: //localhost/ALLUMEDERNIER/espace_membre/profil.php?id='.$_SESSION['id_cli']);
			 //include 'espace_membre/profil.php?id=' . $_SESSION['id_cli'];
      } //On ferme le if
      else { 
	  header('Location: //localhost/ALLUMEDERNIER/espace_membre/seconnecter.php');
