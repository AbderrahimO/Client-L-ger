	...
	if(isset($_POST['forminscription'])) {
	   ...
	   if(!empty($_POST['mail_cli']) AND !empty($_POST['mail_cli2']) AND !empty($_POST['mdp_cli']) AND !empty($_POST['mdp_cli2'])
		AND !empty($_POST['nom_cli']) AND !empty($_POST['prenom_cli']) AND !empty($_POST['adress_cli']) AND !empty($_POST['cp_cli']) AND !empty($_POST['tel_cli'])) {
		  ...
		  $insertmbr = $bdd->prepare("INSERT INTO client(mail_cli, mdp_cli, nom_cli, prenom_cli, tel_cli, adress_cli, cp_cli ) VALUES('".$mail_cli."', '".$mdp_cli."', '".$nom_cli."', '".$prenom_cli."', '".$tel_cli."', '".$adress_cli."', '".$cp_cli."');");
		  error_log("SQL ==> INSERT INTO client(mail_cli, mdp_cli, nom_cli, prenom_cli, tel_cli, adress_cli, cp_cli ) VALUES('".$mail_cli."', '".$mdp_cli."', '".$nom_cli."', '".$prenom_cli."', '".$tel_cli."', '".$adress_cli."', '".$cp_cli."');");
		  $insertmbr->execute();
