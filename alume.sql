...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 29 avr. 2019 à 08:57
...
('fen_10', 'Fenetre bois ouvert', 'image/img/fen_10.jpg', '300.00', 5, 2),
('fen_11', 'Fenetre triple rotor', 'image/img/fen_11.jpg', '350.00', 5, 2),
('fen_12', 'Fenetre a rabat', 'image/img/fen_12.jpg', '340.00', 5, 2),
('fen_13', 'Fenetre porte', 'image/img/fen_13.jpg', '400.00', 5, 3),
('fen_14', 'Fenetre arrondie', 'image/img/fen_14.jpg', '450.00', 5, 3),
('fen_15', 'Fenetre mini', 'image/img/fen_15.jpg', '430.00', 5, 3),
('fen_16', 'Fenetre petite', 'image/img/fen_16.jpg', '410.00', 5, 3),
('fen_17', 'Fenetre large', 'image/img/fen_17.jpg', '600.00', 5, 3),
('fen_18', 'Fenetre rectangulaire', 'image/img/fen_18.jpg', '230.00', 5, 3),
('fen_19', 'Fenetre triple rotator', 'image/img/fen_19.jpg', '210.00', 5, 1),
('fen_2', 'Fenetre bois long', 'image/img/fen_2.jpg', '300.00', 5, 1),
('fen_20', 'Fenetre petit bois', 'image/img/fen_20.jpg', '900.00', 5, 1),
('fen_3', 'Fenetre PVC blanc', 'image/img/fen_3.jpg', '120.00', 5, 1),
('fen_4', 'Fenetre en bois', 'image/img/fen_4.jpg', '140.00', 5, 1),
('fen_5', 'Fenetre PVC noir', 'image/img/fen_5.jpg', '220.00', 5, 1),
('fen_6', 'Fenetre PVC gris', 'image/img/fen_6.jpg', '240.00', 5, 1),
('fen_7', 'Fenetre PVC vitre', 'image/img/fen_7.jpg', '210.00', 5, 1),
('fen_8', 'Fenetre bois fonce', 'image/img/fen_8.jpg', '260.00', 5, 2),
('fen_9', 'Fenetre bois haut', 'image/img/fen_9.jpg', '320.00', 5, 2),
...
('port_10', 'Porte double rotor', 'image/img/port_10.jpg', '300.00', 5, 2),
('port_11', 'Porte de garage grise', 'image/img/port_11.jpg', '350.00', 5, 2),
('port_12', 'Porte de garage marron', 'image/img/port_12.jpg', '340.00', 5, 2),
('port_13', 'Porte de garage coullisant', 'image/img/port_13.jpg', '400.00', 5, 3),
('port_14', 'Porte de garage double', 'image/img/port_14.jpg', '450.00', 5, 3),
('port_15', 'Porte de garage petite', 'image/img/port_15.jpg', '430.00', 5, 3),
('port_16', 'Porte de garage noire', 'image/img/port_16.jpg', '410.00', 5, 3),
('port_17', 'Porte double rotator', 'image/img/port_17.jpg', '600.00', 5, 3),
('port_18', 'Porte de garage beige', 'image/img/port_18.jpg', '230.00', 5, 3),
('port_19', 'Porte anthracite', 'image/img/port_19.jpg', '210.00', 5, 1),
('port_2', 'Porte grise', 'image/img/port_2.jpg', '300.00', 5, 1),
('port_20', 'Porte triple rotor', 'image/img/port_20.jpg', '900.00', 5, 1),
('port_3', 'Porte rectangulaire', 'image/img/port_3.jpg', '120.00', 5, 1),
('port_4', 'Porte lisse', 'image/img/port_4.jpg', '140.00', 5, 1),
('port_5', 'Porte marron', 'image/img/port_5.jpg', '220.00', 5, 1),
('port_6', 'Porte large', 'image/img/port_6.jpg', '240.00', 5, 1),
('port_7', 'Porte avec des vitres', 'image/img/port_7.jpg', '210.00', 5, 1),
('port_8', 'Porte a barre blanche', 'image/img/port_8.jpg', '260.00', 5, 2),
('port_9', 'Porte de batiment', 'image/img/port_9.jpg', '320.00', 5, 2);
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `cp_cli` varchar(255) DEFAULT NULL,
  `nbcom` int(11) DEFAULT '0',
  `avatar` varchar(50) DEFAULT '0.png',
  PRIMARY KEY (`id_cli`)
...
INSERT INTO `client` (`id_cli`, `mail_cli`, `mdp_cli`, `nom_cli`, `prenom_cli`, `datenaiss_cli`, `tel_cli`, `adress_cli`, `cp_cli`,  `nbcom`, `avatar`) VALUES
(1, 'mumin.guvendi@gmail.com', '386cd26a03430055835c4429d132338449a13689', 'Guvendi', 'Mumin', NULL, '651680971', '5b les touleuses mauves', '95000', NULL, 0, '0.png'),
(24, 'mucahit@mucahit.fr', 'e99ed52991be1b97b68d18fe76f0e6127ff58722', 'Guvendi', 'Mucahit', NULL, '0123456788', '5b les touleuses mauves', '95000', NULL, 0, '0.png'),
(25, 'mumin@hotmail.fr', 'e99ed52991be1b97b68d18fe76f0e6127ff58722', 'Herve', 'Loic', NULL, '054612345', '8rue des sabliers', '93000', NULL, 0, '0.png'),
(26, 'jyja@gmail.com', '86a9db8e00a9f960cf79f78996dfdbfeb613abd5', 'Jeremy', 'Charrier', NULL, '0666554466', 'rue du test', '28000', NULL, 0, '0.png'),
(27, 'test@test.fr', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'test', 'test', NULL, '0122347875', 'rue du test', '98000', NULL, 0, '0.png'),
(28, 'client66@hotmail.fr', 'd2a04d71301a8915217dd5faf81d12cffd6cd958', 'Cabon', 'Christelle', NULL, '0651680917', '23 rue de Jordan', '75018', NULL, 0, '0.png'),
(29, 'Chat@hotmail.fr', 'e4b203cd2273969f31fad4df07d1acb0924a0619', 'Chaton', 'Francis', NULL, '0145669877', 'rue des chardons', '280000', NULL, 0, '0.png'),
(30, 'damienabiib@gmail.com', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'Abib', 'Damien', NULL, '0651109933', '88 rue pasteur', '95100  ', NULL, 0, '0.png'),
(31, 'mamarouu@hotmail.fr', '9cf95dacd226dcf43dbba7035218921', 'Marouane', 'Pep', NULL, '01010564020', 'rue des sos', '95830', NULL, 0, '0.png'),
(32, 'eric@hotmail.fr', '9cf95dacd226dcf43dqdqd7035218921', 'Eric', 'Faris', NULL, '01017789020', 'place de la rue', '91000', NULL, 0, '0.png'),
(33, 'freir@gmail.fr', '9cf95dacd226dazazz6cbba5218921', 'Miguel', 'Freire', NULL, '01046561020', 'rue du rouge', '38000', NULL, 0, '0.png'),
(34, 'balo@laposte.net', '9cf95dacd226aeazeeeeda376cdb6cbba708921', 'Balo', 'Bertrand', NULL, '0144569320', 'rue des treize', '15000', NULL, 0, '0.png'),
(35, 'nmolok@yahoo.fr', '9cf95dacd226dczazeazea376cdbba703521', 'Moloque', 'Nathan', NULL, '0237506599', 'rue des platres', '63000', NULL, 0, '0.png'),
(36, 'Tpa@hotmail.fr', '9cf95dacd226dcaeazeaze376cdb6c18921', 'Tap', 'Antony', NULL, '0549780000', 'impasse du pressoir', '88900', NULL, 0, '0.png'),
(37, 'valyo@hotmail.fr', '9cf95dacd226dceeeee376cdb6cbba8921', 'Valerro', 'Yollande', NULL, '0237896522', 'rue du prieure', '28630', NULL, 0, '0.png'),
(38, 'Eloarm@hotmail.fr', '9cf95dacd226dcf43da376cdb6cb18921', 'Army', 'Elodie', NULL, '0875693322', 'rue des anges', '28170', NULL, 0, '0.png'),
(39, 'Erftheo@hotmail.fr', '9cf95dacd226dcf43ddddbba7035218921', 'Erf', 'Theo', NULL, '0452365588', 'rue des animaux', '69882', NULL, 0, '0.png'),
(40, 'Chantal.no@hotmail.fr', '9cf95dacd226dcf4xxx6cbba7035218921', 'No', 'Chantal', NULL, '0237658965', 'place jungle', '01520', NULL, 0, '0.png'),
(41, 'Jospeed@hotmail.fr', '9cf95dacd226dcfxxaaaacdb6cbba8921', 'Vitesse', 'Josiane', NULL, '0355664488', 'rue allende', '78520', NULL, 0, '0.png'),
(42, 'testfinal@gmail.com', 'c2db4744e6e98778900f74c3ebb13fd7580a9b78', 'nomfinal', 'prenomfinal', NULL, '0651689729', 'adresse', '95000', NULL, 0, '0.png'),
(43, 'ka77950@gmail.com', '7e240de74fb1ed08fa08d38063f6a6a91462a815', 'ka', 'ka', NULL, '0160565657', 'paris', '75000', NULL, 0, '0.png'),
(44, 'tristan.chat@test.fr', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'chat', 'tristan', NULL, '0678787878', '2RRR', '78600', NULL, 0, '0.png'),
(45, 'test@free.fr', '7b21848ac9af35be0ddb2d6b9fc3851934db8420', 'TEST', 'Test', NULL, '0123456789', '10 rue du bord', '75015', NULL, 0, '0.png'),
(46, 'damieniris@test.fr', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'ABI', 'Damien', NULL, '0651109933', '77 rue des murraux', '95100', NULL, 0, '0.png'),
(47, 'julien@gmail.fr', '8cb2237d0679ca88db6464eac60da96345513964', 'julien', 'juju', NULL, '0651109977', 'juliette', 'jiji', NULL, 1, '0.png'),
(48, 'damien@iris.fr', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'ABIB', 'Damien', NULL, '0651109933', '88 rue pasteur', '95100', NULL, 0, '0.png');
